...
const Dot = () => {
  return (
    <div className="h-6 w-6 bg-white dark:bg-neutral-800 flex items-center justify-center rounded-full">
...
const SVGVertical = ({ className }: { className?: string }) => {
  ...
  return (
    <motion.svg
      ...
      className={cn("text-neutral-100 dark:text-neutral-700", className)}
    >
